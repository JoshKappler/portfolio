...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Multi-provider LLM abstraction so roles can swap backends mid-game — Claude API, Claude Agent SDK, Groq, or OpenRouter",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Runs on the same multi-provider LLM layer as my other agent projects — Claude API, Claude Agent SDK, Groq, or OpenRouter, picked via environment variable",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Dual Claude client: SDK with tool_use for structured scene output, CLI fallback for Max plan when no API key is set",
