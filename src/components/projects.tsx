...
const projects = [
  {
    ...
    gallery: [
      "/memo-engine/workspace.png",
      "/memo-engine/tear-sheet.png",
      "/memo-engine/memo-review.png",
    ],
    galleryCaption: "Live demo: the AMC Entertainment run, end to end",
  ...
  },
  {
    ...
    gallery: [
      "/claim-wright/claim-detail.png",
      "/claim-wright/past-runs.png",
      "/claim-wright/training-workbench.png",
    ],
    galleryCaption: "The claim workspace, batch history, and calibration workbench (sample data)",
    galleryLandscape: true,
  ...
  },
  {
    ...
    gallery: [
      "/autohack/dashboard-overview.png",
      "/autohack/findings.png",
    ],
    galleryCaption: "The real-time hunt dashboard (sample data)",
    galleryLandscape: true,
  ...
  },
  {
    ...
    gallery: [
      "/pinch/conversation.png",
      "/pinch/working.png",
      "/pinch/approve-diff.png",
      "/pinch/agents.png",
      "/pinch/modes.png",
    ],
    galleryCaption: "Real screens from the watchOS app",
